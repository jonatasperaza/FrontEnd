...
function verify() {
  if (
    employeeStore.state.employee_data.address.cep === '' ||
    employeeStore.state.employee_data.address.number === ''
  ) {
...
<template>
  <form @submit.prevent>
    ...
    <input
      ...
      v-model="employeeStore.state.employee_data.address.cep"
    />
    ...
    <input
      ...
      :value="employeeStore.state.employee_data.address.state"
      disabled
    />
    ...
    <input
      ...
      :value="employeeStore.state.employee_data.address.city"
      disabled
    />
    ...
    <input
      ...
      v-model="employeeStore.state.employee_data.address.neighborhood"
    ...
    <input
      ...
      v-model="employeeStore.state.employee_data.address.street"
      :disabled="canStreet"
    />
    ...
    <input
      ...
      v-model="employeeStore.state.employee_data.address.number"
    />
    ...
    <button
      ...
      @click="
        verify()
          ? (router.push('/'), employeeStore.createEmployee(employeeStore.state.employee_data))
          : null
      "
    >
      Finalizar
